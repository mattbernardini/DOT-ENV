...
# additional path variables in order to allow CUDA and CuDNN to run
export PATH=$HOME/bin:/usr/local/cuda/bin:$PATH
export LD_LIBRARY_PATH=$HOME/lib:$HOME/lib64:/usr/local/cuda/lib64:$HOME/.mujoco/mjpro150/bin:/usr/local/cuda-9.0/extras/CUPTI/lib64:$LD_LIBRARY_PATH
export CPATH=/usr/local/cuda/include:$HOME/include:/usr/include:/usr/lib/x86_64-linux-gnu/openmpi/include:$CPATH
...
PATH="/home/matt/lfs/bin:/home/matt/perl5/bin${PATH:+:${PATH}}"; export PATH;
